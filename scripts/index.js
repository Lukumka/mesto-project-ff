...
addCardButton.addEventListener('click', ()=>{addCardPopUp.classList.add('popup_is-opened')});
closePopUpButton.addEventListener('click', ()=>{addCardPopUp.classList.remove('popup_is-opened')});
//функция добавления карточки
saveCardButton.addEventListener('click', ()=>{
        const newCard = [];
        const cardData ={};
        cardData.name = addCardPopUp.querySelector('.popup__input_type_card-name').value;
